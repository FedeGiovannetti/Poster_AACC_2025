...
header-includes:
  - \raggedbottom
  - \setlength{\footskip}{0pt}    # elimina espacio de footer extra
  - \setlength{\textheight}{1\paperheight}  # fuerza que el contenido no rompa página
---
...
#main-img-right {
  ...
  right: 3%;
  top: 15%;
  width: 300px;         /* Tamaño fijo más seguro */
  height: 300px;
  object-fit: contain;
}
</style>
