...
Dominico <- read.csv("../data/Bases PICT 2017 (Villa Dominico)/PICT_2019_filtered.csv")%>% 
  # mutate(PROYECTO = "Dominico") %>% 
...
saveRDS(object = plot.des, file = "Figuras/FiguraDominico.Rds")
