...
datos = read.csv("../datos_normalizados_B.csv")
...
Muestra_B <- read.csv("../data/Bases PICT 2014/PICT_2014_PRE_filtered.csv")%>% 
...
saveRDS(object = plot.des, file = "Figuras/FiguraMuestraB.Rds")
