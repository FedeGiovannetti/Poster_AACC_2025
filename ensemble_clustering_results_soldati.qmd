...
datos = read.csv("../datos_normalizados_soldati.csv")
datos.reducidos = read.csv("../datos_reducidos.csv") %>% 
  filter(PROYECTO == "Soldati") %>% 
  select(-PROYECTO)
...
Soldati <- read.csv("../data/Bases PICT 2014 (Villa Soldati)/PICT_2014_PRE_filtered.csv")%>% 
...
saveRDS(object = plot.des, file = "Figuras/FiguraSoldati.Rds")
